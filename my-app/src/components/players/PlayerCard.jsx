...
function PlayerCard({ player }) {
  ...
  const positionName = (player.preferredPosition || "Unknown Player").replace(/_/g, " ");

  return (
    <div className="bg-slate-900/40 backdrop-blur-md rounded-3xl p-6 border border-slate-800/50 transition-all duration-300 hover:border-emerald-500/40 hover:translate-y-[-4px] group overflow-hidden shadow-lg">
